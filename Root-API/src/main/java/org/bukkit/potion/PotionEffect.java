...
public class PotionEffect implements ConfigurationSerializable {
	 ...
	 * @see LivingEntity#addPotionEffect(PotionEffect, PotionEffectAddEvent.EffectAddReason)
	 */
	public boolean apply(LivingEntity entity) {
		return entity.addPotionEffect(this, PotionEffectAddEvent.EffectAddReason.CUSTOM);
	}
