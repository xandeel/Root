...
public interface LivingEntity extends Entity, Damageable, ProjectileSource {
	 ...
	 * @return whether the effect could be added
	 */
	boolean addPotionEffect(PotionEffect effect, PotionEffectAddEvent.EffectAddReason reason);
	 ...
	 * @return whether the effect could be added
	 */
	boolean addPotionEffect(PotionEffect effect, boolean force, PotionEffectAddEvent.EffectAddReason reason);
	 ...
	 * @return whether all of the effects could be added
	 */
	boolean addPotionEffects(Collection<PotionEffect> effects, PotionEffectAddEvent.EffectAddReason reason);
