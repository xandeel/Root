...
public class EntityZombie extends EntityMonster {
	...
	protected void a(int i) {
		...
		this.addEffect(new MobEffect(MobEffectList.INCREASE_DAMAGE.id, i, Math.min(this.world.getDifficulty().a() - 1, 0)), PotionEffectAddEvent.EffectAddReason.VILLAGER_CURE);
